...
#SBATCH -o jobs/$USER_%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e jobs/$USER_%j.err                 # File to which STDERR will be written, including job ID (%j)
